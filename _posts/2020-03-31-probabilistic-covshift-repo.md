---
title: 'Tackling Covariate Shift in ML Using ML'
date: 2020-03-31
permalink: /posts/2020/03/tackling-covariate-shift-in-ml-using-ml/
tags:
  - machine learning
...
In the previous <a href="https://albertuskelvin.github.io/posts/2020/03/density-ratio-estimation-probabilistic-classification/">post</a> I mentioned about a simple way of estimating the density ratio of two probability distributions. I decided to create a python package that provides such a functionality.

You can find the repo <a href="https://github.com/albertuskelvin/probabilistic-covshift">here</a>.
